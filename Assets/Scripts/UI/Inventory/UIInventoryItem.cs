...
namespace Strungerhulder.UI.Iventory
{
    public class UIInventoryItem : MonoBehaviour
    {
        ...
        public void HoverItem() => m_ImageHover.gameObject.SetActive(true);

        public void UnhoverItem() => m_ImageHover.gameObject.SetActive(false);
        ...
        public void UnselectItem() => m_ImageSelected.gameObject.SetActive(false);
    }
}
